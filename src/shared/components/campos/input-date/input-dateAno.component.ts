...
export const APP_DATE_FORMATS_ANO =
  {
    parse: {
...
@Component({
  ...
  providers: [{provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS_ANO}],
})
export class InputDateAnoComponent {
